...
public class Lematize {
	 ...
	 protected StanfordCoreNLP pipeline;
	    ...
	    public List<String> lemmatizer(String documentText)
	    {
	    ...
	    public static void main(String[] args) throws IOException {
	    	String filePath = "J:/Assignment1_ISI/rural.txt";
	    	String outfilePath = "J:/Assignment1_ISI/lemmatizedrural.txt";
	       ...
	       // System.out.println(slem.lemmatizer(content));
	        FileWriter writer =new FileWriter(outfilePath) ;
	        writer.write(slem.lemmatizer(content).toString());
	        writer.close();
